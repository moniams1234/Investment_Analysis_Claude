...
def build_pnl(forecast_df: pd.DataFrame, setup: dict) -> pd.DataFrame:
    ...
    for _, r in forecast_df.iterrows():
        ...
        #    Investment Depreciation for the specific year in Forecast Input;
        ...
        manual_investment_dep = float(r.get("Investment Depreciation", 0) or 0)
        other_fa_dep = float(r.get("Other FA Depreciation", 0) or 0)
