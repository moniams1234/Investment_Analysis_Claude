...
with tabs[2]:
    ...
    col_cfg = {
        ...
        "Investment Depreciation": st.column_config.NumberColumn("Investment Depreciation", format="%.0f", min_value=0.0, help="Yearly depreciation of the project investment. If entered, it overrides automatic depreciation from Project Setup for that year."),
        "Other FA Depreciation": st.column_config.NumberColumn("Other FA Depreciation", format="%.0f", min_value=0.0, help="Yearly depreciation/amortisation of other fixed assets to include in P&L."),
    }
    disabled_cols = ["Year"]
